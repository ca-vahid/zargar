...
DEFAULTS: dict[str, Any] = {
    ...
    "techniques.options_cartel.intraday_research": False,  # non-executing Practice observations only
    ...
    "techniques.options_cartel.profitability_research": False,  # prospective Practice studies, never orders
    ...
    "options.cboe_open_quiet": True,   # 2026-09-24: background CBOE chain requests (enrichment, research) stand down 09:29-09:34 ET so live option picks get the provider at the open (four EM short entries died to 429s at 09:31 on 09-24). Entries and held-position reads are never held back
