...
TECHNIQUE_SOURCE_REVISED = "TechniqueSourceRevised"      # Delivery B: an accepted source edit/delete/restore (never touches positions)          # Delivery B: an order-free scenario candidate asked to arm
