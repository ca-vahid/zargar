...
- **2026-09-24 evening: EM Experimental RETIRED** (paused `em-experiment-retired`, experiment disabled, history kept; -1,035.75 on 17 trades). EM runs one book, EM Practice, deterministic, shares fallback OFF (preregistered test decided). No further EM development: the stop rule (3 of 20 sessions) decides. Cross-desk plan: `docs/PLAN-2026-09-24-SHARP-PENCIL.md`.
