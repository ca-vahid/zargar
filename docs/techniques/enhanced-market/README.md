...
- **Handoff 2026-09-18: live v0.8.13 build `1150fed` (a direct `restart.ps1` at 19:55 PT moved the runtime onto Team2 #204 - not this desk); 39 EM arms; 0.8.14 candidate `632913c` (P-06 partial-depth + main e8aeb25 + runtime 1150fed) tested, NOT deployed; morning review = session cron + backup task `ZargarEmTickBackup`; ED-04 design in `research/EXECUTABLE-PROFIT-RECORD-DESIGN.md`, recorder next (OFF by default).**
