...
- **Integrated delivery 2026-09-18 evening (0.8.21 candidate, NOT deployed): source scenarios + plan matcher, the preparation policy owner (baseline default / deterministic built), order-free source continuation + requalification, first-sale R at the final quantity (observe), the ED-04 executable-profit recorder + reducer + report (OFF) and a read-only review panel on Validation. One closure: `reviews/INTEGRATED-DELIVERY-RESPONSE-2026-09-18.md`; frozen definitions: `research/PROSPECTIVE-DEFINITIONS-2026-09-18.md`. Baseline Practice preparation and trading unchanged; activation and deployment are separate user decisions.**
