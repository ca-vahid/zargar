...
- **0.8.14 candidate `586ed13` (P-06 partial-depth rule + main edc5dd0) tested, NOT deployed - rides the next coordinated release; live v0.8.13. Next: the executable-profit measurement (ED-04).**
