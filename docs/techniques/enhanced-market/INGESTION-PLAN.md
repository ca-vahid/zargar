...
R2, grade >= `ingest.auto_arm_min_grade` (B), the deterministic entry decision at fire (since 2026-09-15; before that the critic, advisory on at-level bounces/rejects from 2026-09-09 - TRADING-RULES §5), loss halt, Practice).
