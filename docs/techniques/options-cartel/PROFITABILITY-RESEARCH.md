...
Practice [verified provider intervals](VERIFIED-INTERVALS.md) carry explicit live
evidence and availability cutoffs. A research/replay input without those proofs
retains strict minute requirements; do not interpret its data refusal as proof
that a repaired live entry was invalid or as an observed missed trade.
