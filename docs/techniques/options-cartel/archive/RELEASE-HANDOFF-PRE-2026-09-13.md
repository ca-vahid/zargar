...
Retained for implementation/test provenance. Present-tense status statements below describe the original checkpoint, not current behavior. Use [current documentation](../README.md).
