...
- **Economics review 2026-09-19 (`research/2026-09-19-economics-review.md`):** Tips Practice marked -$1,035.54 over 9 sessions (method -$939.11 net of fees; questioned MRNA/APLD apart; RKT repair apart) plus >= $494.59 priced model cost. Losses concentrate in short-dated options held overnight and sold in the first seconds of the next session (six exits -$999.09); takes did not beat skips on identical horizons. Proposals D1-D6 await decisions; no policy changed. `tools/tip_scorecard.py` is the reconciled daily view; the intake review gate runs in OBSERVE.
