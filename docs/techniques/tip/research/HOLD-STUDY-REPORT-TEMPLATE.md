...
## Observation counts (per arm, per setup; every row counted)

| arm | setup | eligible rows | fresh both ends | pre-close missing / late / ineligible / outside_window | next-open missing / late / ineligible / missed | adequate pairs | distinct positions |
|---|---|---:|---:|---|---|---:|---:|
...
| setup | n pairs | insufficient | quote-drift carry net | intraday net | mean carry R | mean intraday R | paired diff R | managed known | managed net | sacrificed winners |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
