...
|---|---|---|---|---|
| MRNA (sim) | no | none between 15:50:10 and 09:30:03 ET | **unknown** (still open at the sample) | Chronology: the 09:29:49-09:29:55 ET policy re-plan (stop 134.37 -> 145.50, ladder 155/162 x 0.5/0.5) happened BEFORE the 09:30:03 sample and moved no shares, so the quote-drift arithmetic is unaffected; AFTER the sample the strategy acted: 09:39:07 analyst follow-up close 2 sh @ 152.97 (source KianTrades "sold some MRNA here at 153.21"), stop -> 148.00; 09:45:00 TP1 155 trim 2 sh @ 154.37. 3 sh remain. None of this is in the pair; it is the managed path, reported when the position closes. |
