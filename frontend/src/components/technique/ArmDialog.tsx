          ...
          <div className="tq-arm-block">
            ...
            {mode !== "alert" && (
              <div className="tq-row tq-arm-size">
                ...
                {mode === "auto" && opts.fireDecisionMode !== "deterministic" && <label className="tq-chipbtn"><input type="checkbox" checked={useCritic} disabled={!opts.llmAvailable} onChange={(e) => setUseCritic(e.target.checked)} />
